...
function newCart(){
    ...
    // ul.classList.add("my-list","list-group","list-group-flush");
...
function updateCartUi(){
    ...
    cart.forEach(item => {
        ...
        // productitem.classList.add("list-group-item","my-li");
        productitem.classList.add("list-item","d-flex","justify-content-between","align-items-center");
...
function btnOldUi(id){
    const num = document.querySelector(`button[data-id='${id}']`);
    num.innerHTML='<img class="m-2" src="./img/icon-add-to-cart.svg" alt="icon">Add to Cart'
    // num.textContent="Add to Cart";
}
...
function quantityNum(id, set) {
    ...
    if (existingProduct) {
        ...
        } else if (set === "dec" && existingProduct.quantity > 1) {
            existingProduct.quantity--;
        }
